...
<div className='proj'><h2 >Projects</h2></div>
        <div class="main-content animated bounceInLeft">
                <div class="card"> 
                        ...
                        <a class="btn" href="http://evolutionhealth.us/" target='blank'>Learn more</a>        
                </div> 
                <div class="card">
                        <img src={MEBUIMG}/><br/>
                        ...
                        <a className="btn" href="http://mebu.herokuapp.com/" target='blank'>Learn more</a>   
                </div>     
        </div>
